...
class OeHealthFamily(models.Model):
    ...
    telefono = fields.Char(size=15, string='Telefono', help='Numero de telefono')
...
class OeHealthPatient(models.Model):
    ...
    ARBOL_DIAGNOSTICO = [
        ('Factores biologicos de riesgo','Factores biologicos de riesgo'),
	('Trastornos de la comunicacion y el lenguaje','Trastornos de la comunicacion y el lenguaje'),
	('Trastornos del espectro autista','Trastornos del espectro autista'),
	('Trastornos motores','Trastornos motores'),
	('Enfermedades geneticas del metabolismo','Enfermedades geneticas del metabolismo'),
	('Otras','Otras'),
    ...
    escolarizacion = fields.Selection(ESCOLARIZACION, string='Modalidad Escolarizacion')
    intervencion = fields.Selection(INTERVENCION, string='Tipo de Intervencion')
    arbol_diagnostico = fields.Selection(ARBOL_DIAGNOSTICO, string='Arbol diagnostico')
    grado_discapacidad = fields.Text(string='Grado de Discapacidad') 
    grado_dependencia = fields.Text(string='Grado de Dependencia')
    centro_escolar = fields.Text(string='Centro de Escolarizacion')
    sesiones_semanales = fields.Char(string='Numero sesiones semanales',size=32)
...
class OeHealthAppointment(models.Model):
    ...
    tipo_cita = fields.Selection(APPOINTMENT_TYPE, string='Tipo de cita', readonly=True, states={'Scheduled': [('readonly', False)]}, default=lambda *a: 'Menor')
    ...
    patient_modo = fields.Selection(PATIENT_MODO, string='Tipo Asistencia', readonly=True, states={'Scheduled': [('readonly', False)]}, default=lambda *a: 'Normal')
